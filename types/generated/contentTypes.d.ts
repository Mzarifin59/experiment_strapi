...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ParentCategories: Schema.Attribute.Relation<
      'manyToOne',
      'api::category.category'
    >;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    categoryMenu: Schema.Attribute.Component<'page.related-article', false>;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    faq: Schema.Attribute.Component<'page.faq', true>;
    faqs: Schema.Attribute.Relation<'oneToMany', 'api::faq.faq'>;
    footer: Schema.Attribute.Component<'footer.footer-components', false>;
    ...
    > &
      Schema.Attribute.Private;
    navbar: Schema.Attribute.Component<'navbar.navbar-components', false>;
    publishedAt: Schema.Attribute.DateTime;
    relationArticle: Schema.Attribute.Component<'page.related-article', false>;
    seo: Schema.Attribute.Component<'shared.seo', false>;
    slug: Schema.Attribute.UID<'title'>;
